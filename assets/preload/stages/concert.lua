function onCreate()
	...
	makeAnimatedLuaSprite('simps','concert/bunch_of_simps',-205, 685) --fix later
	addAnimationByPrefix('simps','bop','Downer Crowd Bob',24,true)
	setScrollFactor('simps', 0.85, 0.85);
	addLuaSprite('simps',true)
	objectPlayAnimation('simps','bop',false)
	scaleObject('simps', 1.10, 1.10);
...
function onBeatHit( ... )--for every beat
	objectPlayAnimation('simps','bop',true)
